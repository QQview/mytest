...
class Scholarship(models.Model):
    """学位课程奖学金"""
    degree_course = models.ForeignKey("DegreeCourse",default='')
...
class Course(models.Model):
    """专题课程 OR 学位课模块"""
    name = models.CharField(max_length=128 ) # Python基础
    course_img = models.CharField(max_length=255)

    sub_category = models.ForeignKey("CourseSubCategory",default='') #

    course_type_choices = ((0, '付费'), (1, 'VIP专享'), (2, '学位课程'),(3,'免费课'))
    course_type = models.SmallIntegerField(choices=course_type_choices,default='')
    ...
    order = models.IntegerField("课程顺序", help_text="从上一个课程数字往后排",default='')
    attachment_path = models.CharField(max_length=128, verbose_name="课件路径", blank=True, null=True)
    status_choices = ((0, '线上'), (1, '下线'), (2, '预上线'))
...
class CourseDetail(models.Model):
    ...
    hours = models.IntegerField("课时",default='')
    course_slogan = models.CharField(max_length=125, blank=True, null=True)
    video_brief_link = models.CharField(verbose_name='课程介绍', max_length=255, blank=True, null=True)
    why_study = models.TextField(verbose_name="为什么学习这门课程",default='')
    what_to_study_brief = models.TextField(verbose_name="我将学到哪些内容",default='')
    career_improvement = models.TextField(verbose_name="此项目如何有助于我的职业生涯",default='')
    prerequisite = models.TextField(verbose_name="课程先修要求", max_length=1024,default='')
...
class OftenAskedQuestion(models.Model):
    """常见问题"""
    content_type = models.ForeignKey(ContentType, blank=True, null=True,default='',)  # 关联course or degree_course
...
class CourseOutline(models.Model):
    """课程大纲"""
    course_detail = models.ForeignKey("CourseDetail", blank=True, null=True,default='',related_name='outlines')
...
class CourseSection(models.Model):
    """课时目录"""
    chapter = models.ForeignKey("CourseChapter", related_name='coursesections', blank=True, null=True,default='')
    name = models.CharField(max_length=128)
...
class Homework(models.Model):
    chapter = models.ForeignKey("CourseChapter", blank=True, null=True,default='')
...
class Article(models.Model):
    ...
    source = models.ForeignKey("ArticleSource", verbose_name="来源",related_name='article_source')
